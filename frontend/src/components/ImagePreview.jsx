 ...
 *
 * Download is driven entirely by the backend: the endpoint sends
 * `Content-Disposition: attachment; filename="composited_<size>.jpg"`
 * and the URL itself ends in the extension, so a plain link saves the
 * file with the correct name in every browser (no blob, no JS `download`
 * attribute that Safari/others strip or ignore).
 */
